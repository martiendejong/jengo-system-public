...
.PARAMETER BaseRepos
    Array of base repository paths. Configure with your project repositories.
...
param(
    [string[]]$BaseRepos = @(
        # Add your project repository paths here:
        # "$env:PROJECTS_ROOT\my-project"
    )
...
,
    [string]$PoolFile = "$PSScriptRoot\..\_machine\worktrees.pool.md",
    [switch]$Compact
)
